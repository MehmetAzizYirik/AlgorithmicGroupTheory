...
public class MyRunnable implements Runnable {
    ...
    public ThreadLocal<ArrayList<Integer>> getPartition(
            int[] degrees, ArrayList<Integer> partition) {
    ...
    public void run() {
        ...
        ThreadLocal<List<ArrayList<Integer>>> partList =
                new ThreadLocal<List<ArrayList<Integer>>>();
        // trialAbstractClass.partitionList.clear();
        ThreadLocal<ThreadLocal<List<ArrayList<Integer>>>> formers =
                new ThreadLocal<ThreadLocal<List<ArrayList<Integer>>>>();
        // trialAbstractClass.formerPermutations.clear();
        trialAbstractClass.initialPartition =
                trialAbstractClass.getPartition(degree, trialAbstractClass.occurrences);
